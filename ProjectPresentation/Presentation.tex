...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]
		\node[anchor=south west, yshift=0cm] at (current page.south west) {\includegraphics[width=\paperwidth,trim={0 0 0 1.5cm},clip]{Figures/IntroCavierI.pdf}};
	\end{tikzpicture}
\end{frame}
...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]
		\node[anchor=south west, yshift=0cm] at (current page.south west) {\includegraphics[width=\paperwidth,trim={0 0 0 1.5cm},clip]{Figures/IntroCavierII.pdf}};
	\end{tikzpicture}
\end{frame}
...
\begin{frame}
	...
	\begin{enumerate}
		\item Implement CaVieR
		\item Proof correctness \& completeness
...
\begin{frame}
	...
	\begin{algorithm}[H]
		\caption{Single Rewriting}\label{alg:SingleRewriting}
		\begin{algorithmic}[1]
...
\begin{frame}
	...
	\begin{algorithm}[H]
		\caption{All Rewritings}\label{alg:AllRewriting}
		\begin{algorithmic}[1]
