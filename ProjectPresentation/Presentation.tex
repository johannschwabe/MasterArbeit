...
\begin{frame}
	\frametitle{Introduction}
	\framesubtitle{CaVieR: Extending F-IVM to multi query scenarios}
	Change from Individual processing of Queries to Overlapping CaVieR execution
\end{frame}
